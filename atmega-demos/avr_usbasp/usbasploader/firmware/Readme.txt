...
"bootloaderconfig.h". See the documentation in the example provided
with this distribution for details. Then edit "Makefile.inc" to reflect
...
check whether you need to edit the "Makefile.inc" & "Makefile" (e.g. change device settings,
